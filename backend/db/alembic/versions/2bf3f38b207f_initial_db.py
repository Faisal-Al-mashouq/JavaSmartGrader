...
def upgrade() -> None:
    ...
    sa.Column('user_role', sa.Enum('student', 'instructor', name='userrole'), nullable=False),
    ...
    sa.Column('state', sa.Enum('submitted', 'processing', 'graded', 'failed', name='submission_state'), nullable=False),
