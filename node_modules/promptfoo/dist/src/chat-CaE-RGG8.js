import { _ as getEnvBool, b as getEnvString, i as logger_default, v as getEnvFloat, w as cliState_default, y as getEnvInt } from "./logger-q5I8CByj.js";
import { r as importModule } from "./esm-D40XsWlR.js";
import { i as isJavascriptFile } from "./fileExtensions-ePDqouxn.js";
import { d as maybeLoadToolsFromExternalFile, g as renderVarsInObject, l as maybeLoadFromExternalFileWithVars, u as maybeLoadResponseFormatFromExternalFile } from "./util-DKlIKOnZ.js";
import { g as parseChatPrompt, p as REQUEST_TIMEOUT_MS } from "./fetch-4xPs0SRF.js";
import { a as fetchWithCache } from "./cache-DSW7FdwS.js";
import { n as withGenAISpan } from "./genaiTracer-CNawybn-.js";
import { C as renderAuthVars, S as getOAuthTokenWithExpiry, b as getAuthHeaders, i as transformMCPToolsToOpenAi, w as TOKEN_REFRESH_BUFFER_MS, x as getAuthQueryParams, y as applyQueryParams } from "./transform-DF_Z_INN.js";
import { t as OpenAiGenericProvider } from "./openai-CQozD_Ef.js";
import { a as calculateOpenAICost, c as getTokenUsage, t as OPENAI_CHAT_MODELS } from "./util-ktUxLAOK.js";
...
var OpenAiChatCompletionProvider = class OpenAiChatCompletionProvider extends OpenAiGenericProvider {
	...
	*/
	...
	async getOpenAiBody(prompt, context, callApiOptions) {
		...
		const fileTools = config.tools ? await maybeLoadToolsFromExternalFile(config.tools, context?.vars) || [] : [];
...
//# sourceMappingURL=chat-CaE-RGG8.js.map