...
function sanitizeForDb(obj) {
	...
	try {
		...
		if (serialized === void 0) {
			require_logger.logger_default.debug("sanitizeForDb: Failed to serialize object, using fallback", {
		...
		require_logger.logger_default.debug("sanitizeForDb: Parse error, using fallback", { error });
		return Array.isArray(obj) ? [] : null;
	}
}
...
//# sourceMappingURL=evalResult-DNJQ8Eph.cjs.map