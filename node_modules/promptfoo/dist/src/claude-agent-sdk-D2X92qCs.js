import { A as logger_default, F as cliState_default, P as getEnvString, T as resolvePackageEntryPoint, f as ANTHROPIC_MODELS, p as transformMCPConfigToClaudeCode, w as importModule } from "./server/index.js";
import { n as getCachedResponse, r as initializeAgenticCache, t as cacheResponse } from "./cloudflare-gateway-Bk3YZvTs.js";
...
var ClaudeCodeSDKProvider = class ClaudeCodeSDKProvider {
	...
	async callApi(prompt, context, callOptions) {
		...
		if (!this.apiKey && !(env.CLAUDE_CODE_USE_BEDROCK || env.CLAUDE_CODE_USE_VERTEX)) throw new Error(dedent`Anthropic API key is not set. Set the ANTHROPIC_API_KEY environment variable or add "apiKey" to the provider config.
...
//# sourceMappingURL=claude-agent-sdk-D2X92qCs.js.map