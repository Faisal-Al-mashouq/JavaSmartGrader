...
var DMRChatCompletionProvider = class extends require_chat.OpenAiChatCompletionProvider {
	async callApi(prompt, context, callApiOptions) {
		if (!await hasLocalModel(this.modelName, this.getApiUrl())) require_logger.logger_default.warn(`Model '${this.modelName}' not found. Run 'docker model pull ${this.modelName}'.`);
...
//# sourceMappingURL=docker-FpnGk-RO.cjs.map