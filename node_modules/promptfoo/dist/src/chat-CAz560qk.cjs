...
const require_util$1 = require('./util-CHAqsUj1.cjs');
...
var OpenAiChatCompletionProvider = class OpenAiChatCompletionProvider extends require_openai.OpenAiGenericProvider {
	...
	*/
	...
	async getOpenAiBody(prompt, context, callApiOptions) {
		...
		const fileTools = config.tools ? await require_util.maybeLoadToolsFromExternalFile(config.tools, context?.vars) || [] : [];
...
//# sourceMappingURL=chat-CAz560qk.cjs.map