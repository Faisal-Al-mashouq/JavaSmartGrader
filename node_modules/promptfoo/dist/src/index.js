...
import { A as isApiProvider, C as TestGeneratorConfigSchema, Ct as BaseTokenUsageSchema, D as VarsSchema, E as UnifiedConfigSchema, F as ConversationMessageSchema, G as STRATEGY_COLLECTIONS, I as PartialGenerationError, K as STRATEGY_COLLECTION_MAPPINGS, L as PluginConfigSchema, M as RedteamConfigSchema, O as isGradingResult, P as ProvidersSchema, Q as categoryAliases, R as PolicyObjectSchema, S as TestCasesWithMetadataSchema, St as PromptSchema, T as TestSuiteSchema, Tt as InputsSchema, U as DEFAULT_STRATEGIES, X as isLanguageDisallowedStrategy, Y as isFanoutStrategy, Z as Severity, _ as ScenarioSchema, _t as REDTEAM_PROVIDER_HARM_PLUGINS, a as AtomicTestCaseSchema, at as FINANCIAL_PLUGINS, b as TestCaseWithVarsFileSchema, bt as TELECOM_PLUGINS, c as CompletedPromptSchema, ct as INSURANCE_PLUGINS, d as EvaluateOptionsSchema, dt as MEDICAL_PLUGINS, et as riskCategorySeverityMap, f as GradingConfigSchema, ft as MULTI_INPUT_EXCLUDED_PLUGINS, g as ResultFailureReason, gt as PLUGIN_CATEGORIES, h as OutputFileExtension, ht as PII_PLUGINS, i as AssertionTypeSchema, it as DEFAULT_PLUGINS, j as isProviderOptions, k as isResultFailureReason, l as DerivedMetricSchema, lt as LLAMA_GUARD_ENABLED_CATEGORIES, m as OutputConfigSchema, mt as PHARMACY_PLUGINS, n as AssertionSchema, nt as BIAS_PLUGINS, o as BaseAssertionTypesSchema, ot as FOUNDATION_PLUGINS, p as NotPrefixedAssertionTypesSchema, pt as MULTI_INPUT_VAR, q as getDefaultNFanout, r as AssertionSetSchema, rt as DATASET_EXEMPT_PLUGINS, s as CommandLineOptionsSchema, st as HARM_PLUGINS, t as AssertionOrSetSchema, tt as ALIASED_PLUGIN_MAPPINGS, u as EvalResultsFilterMode, ut as LLAMA_GUARD_REPLICATE_PROVIDER, v as SpecialAssertionTypesSchema, vt as REMOTE_ONLY_PLUGIN_IDS, w as TestSuiteConfigSchema, wt as CompletionTokenDetailsSchema, x as TestCasesWithMetadataPromptSchema, xt as UNALIGNED_PROVIDER_HARM_PLUGINS, y as TestCaseSchema, z as StrategyConfigSchema } from "./types-CyCiwPFa.js";
import { A as isGoogleProvider, C as deduplicateTestCases, D as doesProviderRefMatch, E as resultIsForTestCase, M as isProviderAllowed, O as getProviderDescription, S as setupEnv, T as getTestCaseDeduplicationKey, b as loadFunction, c as maybeLoadFromExternalFile, d as maybeLoadToolsFromExternalFile, h as renderEnvOnlyInObject, i as fetchCsvFromGoogleSheet, j as isOpenAiProvider, k as isAnthropicProvider, m as readOutput, n as writeMultipleOutputs, p as readFilters, r as writeOutput, s as maybeLoadConfigFromExternalFile, t as printBorder, v as extractVariablesFromTemplates, w as filterRuntimeVars, x as parseFileUrl, y as getNunjucksEngine } from "./util-DKlIKOnZ.js";
import { A as FILE_METADATA_KEY, D as getShareViewBaseUrl, E as getShareApiBaseUrl, T as getDefaultShareViewBaseUrl, b as DEFAULT_MAX_CONCURRENCY, c as cloudConfig, g as parseChatPrompt, h as isPromptfooSampleTarget, j as HUMAN_ASSERTION_TYPE, k as VERSION, n as fetchWithRetries, p as REQUEST_TIMEOUT_MS, r as fetchWithTimeout, s as CloudConfig, t as fetchWithProxy, w as TERMINAL_MAX_WIDTH, x as DEFAULT_QUERY_LIMIT } from "./fetch-4xPs0SRF.js";
import { n as sleep, t as getCurrentTimestamp } from "./time-CRRzn6vA.js";
import { a as fetchWithCache, o as getCache, r as disableCache, t as cache_exports } from "./cache-DSW7FdwS.js";
import { A as createProviderRateLimitOptions, C as renderPrompt, D as redteamProviderManager, E as loadFromPackage, F as getOrgContext, I as getPluginSeverityOverridesFromCloud, K as VertexChatProvider, N as checkCloudPermissions, O as TokenUsageTracker, P as getCloudDatabaseId, R as isCloudProvider, S as collectFileMetadata, T as isPackagePath, _ as getSessionId, a as resolveProviderConfigs, c as Strategies, d as pluginMatchesStrategyTargets, g as extractVariablesFromJson, h as extractPromptFromTags, i as resolveProvider, j as PromptfooHarmfulCompletionProvider, k as createRateLimitRegistry, l as loadStrategy, n as loadApiProvider, o as MCPProvider, p as extractGoalFromPrompt, q as AIStudioChatProvider, r as loadApiProviders, s as GoogleLiveProvider, t as getProviderIds, u as validateStrategies, v as getShortPluginId, w as runExtensionHook, y as isBasicRefusal, z as resolveTeamId } from "./providers-CUZ1fbU-.js";
import { t as hashPrompt } from "./utils-CmIUQ86D.js";
import { i as sha256, n as isBlobStorageEnabled, r as randomSequence, t as extractAndStoreBinaryData } from "./extractor-DQR1kEkv.js";
import "./genaiTracer-CNawybn-.js";
import { t as OpenAiChatCompletionProvider } from "./chat-CaE-RGG8.js";
import { a as createEmptyTokenUsage, i as createEmptyAssertions, n as accumulateResponseTokenUsage, o as normalizeTokenUsage, r as accumulateTokenUsage, t as accumulateAssertionTokenUsage } from "./tokenUsageUtils-BQVp2uKF.js";
import { f as validateFunctionCall } from "./transform-DF_Z_INN.js";
import "./messages-DCdqoM1h.js";
import "./util-GUeNxVoV.js";
import "./openai-CQozD_Ef.js";
import { l as validateFunctionCall$1 } from "./util-ktUxLAOK.js";
import "./completion-HgnjwNon.js";
import { c as setUserEmail, i as getUserEmail, l as EMAIL_OK_STATUS, r as getAuthor, s as promptForEmailUnverified, t as checkEmailStatusAndMaybeExit } from "./accounts-BHfBA-Za.js";
import { i as getRemoteGenerationUrl, l as shouldGenerateRemote, o as getRemoteHealthUrl, r as promptYesNo, s as neverGenerateRemote } from "./server-DkpSTHE4.js";
import { t as getBlobByHash } from "./blobs-zfeA0Dke.js";
import { a as evalsTable, c as evalsToTagsTable, d as tagsTable, i as evalResultsTable, l as promptsTable, m as getDbSignalPath, o as evalsToDatasetsTable, p as getDb, r as datasetsTable, s as evalsToPromptsTable } from "./tables-Dy5j8PcW.js";
import { n as telemetry_default } from "./telemetry-CBTAdhX5.js";
import { n as getTraceStore } from "./store-Pa4rFwUw.js";
import { t as ellipsize } from "./text-0N7RUcfQ.js";
import "./base-B8U5SHXx.js";
import "./image-pFZckGf6.js";
import { t as providerRegistry } from "./providerRegistry-5UB8YVkk.js";
import { n as runRuby } from "./rubyUtils-CI4Y5f08.js";
import { t as EvalResult } from "./evalResult-20fZ-3St.js";
...
async function startOtlpReceiverIfNeeded(testSuite) {
	...
	if (testSuite.tracing?.enabled && testSuite.tracing?.otlp?.http?.enabled && !otlpReceiverStarted) {
		...
		try {
			...
			const { startOTLPReceiver } = await import("./otlpReceiver-9PkCcnK9.js");
...
async function stopOtlpReceiverIfNeeded() {
	if (otlpReceiverStarted) try {
		...
		const { stopOTLPReceiver } = await import("./otlpReceiver-9PkCcnK9.js");
...
async function generateTraceContextIfNeeded(test, evaluateOptions, testIdx, promptIdx, testSuite) {
	...
	const { getTraceStore } = await import("./store-CknkWmbE.js");
...
async function runAssertion({ prompt, provider, assertion, test, latencyMs, providerResponse, traceId }) {
	...
	if (typeof renderedValue === "string") if (renderedValue.startsWith("file://")) {
		...
		if (isJavascriptFile(filePath)) {
			...
			const { runRuby } = await import("./rubyUtils-CWkecmDB.js");
	...
	*/
	...
	async _runEvaluation() {
		...
		for (let index = 0; index < tests.length; index++) {
			...
			if (!testCase.provider && typeof testSuite.defaultTest === "object" && testSuite.defaultTest?.provider) {
				...
				if (isApiProvider(defaultProvider)) testCase.provider = defaultProvider;
					...
					const { loadApiProvider } = await import("./providers-C1RMz1vi.js");
		...
		if (cliState_default.resume && this.evalRecord.persisted) try {
			const { default: EvalResult } = await import("./evalResult-f6XDqYcm.js");
