...
import { A as TERMINAL_MAX_WIDTH, D as DEFAULT_QUERY_LIMIT, E as DEFAULT_MAX_CONCURRENCY, F as VERSION, I as FILE_METADATA_KEY, L as HUMAN_ASSERTION_TYPE, M as getShareApiBaseUrl, N as getShareViewBaseUrl, _ as isPromptfooSampleTarget, b as parseChatPrompt, c as cloudConfig, j as getDefaultShareViewBaseUrl, n as fetchWithRetries, p as REQUEST_TIMEOUT_MS, r as fetchWithTimeout, s as CloudConfig, t as fetchWithProxy } from "./fetch-BIPrzD39.js";
import { n as sleep, t as getCurrentTimestamp } from "./time-CRRzn6vA.js";
import { a as fetchWithCache, o as getCache, r as disableCache, t as cache_exports } from "./cache-CMvgAnSi.js";
import { A as createRateLimitRegistry, B as resolveTeamId, C as collectFileMetadata, D as loadFromPackage, E as isPackagePath, F as getCloudDatabaseId, I as getOrgContext, J as AIStudioChatProvider, L as getPluginSeverityOverridesFromCloud, M as PromptfooHarmfulCompletionProvider, O as redteamProviderManager, P as checkCloudPermissions, T as runExtensionHook, _ as extractVariablesFromJson, a as resolveProviderConfigs, b as isBasicRefusal, c as Strategies, d as pluginMatchesStrategyTargets, f as checkExfilTracking, g as extractPromptFromTags, i as resolveProvider, j as createProviderRateLimitOptions, k as TokenUsageTracker, l as loadStrategy, m as extractGoalFromPrompt, n as loadApiProvider, o as MCPProvider, q as VertexChatProvider, r as loadApiProviders, s as GoogleLiveProvider, t as getProviderIds, u as validateStrategies, v as getSessionId, w as renderPrompt, y as getShortPluginId, z as isCloudProvider } from "./providers-CHciOV4f.js";
import { i as generateIdFromPrompt, t as hashPrompt } from "./utils-BWOFfOel.js";
import { i as sha256, n as isBlobStorageEnabled, r as randomSequence, t as extractAndStoreBinaryData } from "./extractor-B9uQA-6-.js";
import "./genaiTracer-CNawybn-.js";
import { t as OpenAiChatCompletionProvider } from "./chat-BH8Fxyap.js";
...
import { f as validateFunctionCall } from "./transform-BwedQA8W.js";
import "./messages-DkV1dizA.js";
import "./util-BnF-xRPi.js";
import "./openai-CQozD_Ef.js";
import { l as validateFunctionCall$1 } from "./util-BXjq8vOq.js";
import "./completion-H4ncr2bK.js";
import { c as setUserEmail, i as getUserEmail, l as EMAIL_OK_STATUS, r as getAuthor, s as promptForEmailUnverified, t as checkEmailStatusAndMaybeExit } from "./accounts-DYMHC4iY.js";
import { i as getRemoteGenerationUrl, l as shouldGenerateRemote, o as getRemoteHealthUrl, r as promptYesNo, s as neverGenerateRemote } from "./server-BKdsd70B.js";
import { t as getBlobByHash } from "./blobs-Dznj-8xW.js";
import { a as evalsTable, c as evalsToTagsTable, d as tagsTable, i as evalResultsTable, l as promptsTable, m as getDbSignalPath, o as evalsToDatasetsTable, p as getDb, r as datasetsTable, s as evalsToPromptsTable } from "./tables-BCcp2r48.js";
...
async function startOtlpReceiverIfNeeded(testSuite) {
	...
	if (testSuite.tracing?.enabled && testSuite.tracing?.otlp?.http?.enabled && !otlpReceiverStarted) {
		...
		try {
			...
			const { startOTLPReceiver } = await import("./otlpReceiver-CO1TzzW1.js");
...
async function stopOtlpReceiverIfNeeded() {
	if (otlpReceiverStarted) try {
		...
		const { stopOTLPReceiver } = await import("./otlpReceiver-CO1TzzW1.js");
...
async function generateTraceContextIfNeeded(test, evaluateOptions, testIdx, promptIdx, testSuite) {
	...
	const { getTraceStore } = await import("./store-CqHttBql.js");
	...
	*/
	...
	async _runEvaluation() {
		...
		for (let index = 0; index < tests.length; index++) {
			...
			if (!testCase.provider && typeof testSuite.defaultTest === "object" && testSuite.defaultTest?.provider) {
				...
				if (isApiProvider(defaultProvider)) testCase.provider = defaultProvider;
					...
					const { loadApiProvider } = await import("./providers-CDib9hVp.js");
		...
		if (cliState_default.resume && this.evalRecord.persisted) try {
			const { default: EvalResult } = await import("./evalResult-Bt2fmj0V.js");
